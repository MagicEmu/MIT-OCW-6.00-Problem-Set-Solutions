...
class Hand(object):
    def __init__(self, handSize, initialHandDict = None):
        ...
        if initialHandDict is None:
            ...
            for i in range(round(num_vowels), handSize):
    ...
    def __eq__(self, other):
        ...
        """
        return self.initialSize == other.initialSize
    def __str__(self):
        """
